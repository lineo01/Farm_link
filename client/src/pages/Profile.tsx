...
import { Settings, MapPin, Phone, Star, Package, TrendingUp } from "lucide-react";
    ...
    <div>
      ...
      <div className="px-4 pb-8">
        ...
        <div className="space-y-1">
          <div className="p-3 hover:bg-muted/30 rounded-lg cursor-pointer transition-colors text-sm font-medium">
            My Listings
          </div>
          <div className="p-3 hover:bg-muted/30 rounded-lg cursor-pointer transition-colors text-sm font-medium">
            Order History
          ...
          <div className="p-3 hover:bg-muted/30 rounded-lg cursor-pointer transition-colors text-sm font-medium text-destructive">
            Log Out
          </div>
        </div>
      </div>
